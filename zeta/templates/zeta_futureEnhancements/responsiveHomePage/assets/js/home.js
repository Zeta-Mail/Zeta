...
function EmailBody() {
	document.querySelector(".emailBody").style.display = "block";
	document.querySelector(".emailContainer").style.display = "none";
}

function backToEmail() {
	document.querySelector(".emailBody").style.display = "none";
	document.querySelector(".emailContainer").style.display = "block";
}

function replyToEmail() {
	document.querySelector(".replyOverlay").style.width = "100%"; 
  document.querySelector(".sendEmailReply").style.display = "block"; 
}

function replyClose() {
	document.querySelector(".replyOverlay").style.width = "0%";  
  document.querySelector(".sendEmailReply").style.display = "none"; 
}

function composeEmail() {
	document.querySelector(".composeOverlay").style.width = "100%"; 
  document.querySelector(".sendEmailComposed").style.display = "block"; 
}

function composeClose() {
	document.querySelector(".composeOverlay").style.width = "0%";  
  document.querySelector(".sendEmailComposed").style.display = "none"; 
}
